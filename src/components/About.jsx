...
const About = () => {
  return (
    <>
      <section className="w-full h-screen bg-gray-800 text-gray-300">
        {/* Container */}
          ...
          <div className="max-w-[1000px] w-full grid gap-8 px-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="leading-7 mb-10">
                ...
                tremendously hard to grow my coding abilities and gain exposure
                to a variety of web technologies...
              </p>
