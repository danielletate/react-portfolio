        ...
        <div className="max-w-[1000px] w-full grid gap-8 px-4 sm:grid-cols-2">
          ...
          <div>
            <p>
              ...
              nesciunt odio fuga ab! Nemo qui quasi eum, voluptates esse
              reprehenderit deserunt possimus, odio quo architecto ea rerum vel
              corrupti? Recusandae, omnis. Quidem ducimus qui aliquam dolores
